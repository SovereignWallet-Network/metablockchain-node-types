...
import type { PeerId, PublicSigningKey } from './metablockchain';
...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    ...
    did: {
       ...
       **/
      add: AugmentedSubmittable<(publicKey: PublicSigningKey | string | Uint8Array, identifier: Bytes | string | Uint8Array, metadata: Option<Bytes> | null | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Removes a DID from chain storage, where
       * origin - the origin of the transaction
       **/
      remove: AugmentedSubmittable<(identifier: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Updates a DID public key on the chain
       * origin - the origin of the transaction
       **/
      rotateKey: AugmentedSubmittable<(identifier: Bytes | string | Uint8Array, publicKey: PublicSigningKey | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    grandpa: {
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
    ...
    nodeAuthorization: {
       ...
       **/
      addConnections: AugmentedSubmittable<(node: PeerId | string | Uint8Array, connections: Vec<PeerId> | (PeerId | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       * - `node`: identifier of the node.
       **/
      addWellKnownNode: AugmentedSubmittable<(node: PeerId | string | Uint8Array, owner: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       * - `node`: identifier of the node.
       **/
      claimNode: AugmentedSubmittable<(node: PeerId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       * - `node`: identifier of the node.
       **/
      removeClaim: AugmentedSubmittable<(node: PeerId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      removeConnections: AugmentedSubmittable<(node: PeerId | string | Uint8Array, connections: Vec<PeerId> | (PeerId | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       * - `node`: identifier of the node.
       **/
      removeWellKnownNode: AugmentedSubmittable<(node: PeerId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      resetWellKnownNodes: AugmentedSubmittable<(nodes: Vec<ITuple<[PeerId, AccountId]>> | ([PeerId | string | Uint8Array, AccountId | string | Uint8Array])[]) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      swapWellKnownNode: AugmentedSubmittable<(remove: PeerId | string | Uint8Array, add: PeerId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      transferNode: AugmentedSubmittable<(node: PeerId | string | Uint8Array, owner: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    scheduler: {
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
    ...
    schema: {
       ...
       **/
      add: AugmentedSubmittable<(hash: Hash | string | Uint8Array, jsonData: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    sudo: {
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
    ...
    validatorSet: {
       ...
       **/
      addMember: AugmentedSubmittable<(newMember: AccountId | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Removes a member.
       **/
      removeMember: AugmentedSubmittable<() => SubmittableExtrinsic<ApiType>>;
    };
    verifiedCredential: {
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
       ...
       **/
      add: AugmentedSubmittable<(schema: Hash | string | Uint8Array, vcHash: Hash | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
  }
